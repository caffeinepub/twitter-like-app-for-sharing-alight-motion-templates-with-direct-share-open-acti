...
import type { CustomizationSettings as _CustomizationSettings, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, VideoFile as _VideoFile, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async cancelPremium(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cancelPremium();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomizationSettings(): Promise<CustomizationSettings | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomizationSettings();
    ...
    async getVideoFile(arg0: bigint): Promise<VideoFile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoFile(arg0);
    ...
    async likeTemplatePost(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeTemplatePost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async repostTemplate(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.repostTemplate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCustomizationSettings(arg0: CustomizationSettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCustomizationSettings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setUserPremium(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUserPremium(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadTemplateVideo(arg0: string, arg1: string, arg2: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadTemplateVideo(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_VideoFile_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoFile): Promise<VideoFile> {
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CustomizationSettings]): CustomizationSettings | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_VideoFile]): Promise<VideoFile | null> {
    return value.length === 0 ? null : await from_candid_VideoFile_n15(_uploadFile, _downloadFile, value[0]);
}
